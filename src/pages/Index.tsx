...
const scheduleData: Record<string, { day: string; date: string; sessions: Session[] }> = {
  ...
  "dec18": {
    ...
    sessions: [
      { id: "o1", title: "Oral Session-1", time: "9:00 - 10:30 AM", location: "Auditorium Complex", variant: "oral", link: "/oral-sessions" },
      { id: "p1", title: "Plenary-1: Prof Nicu Sebe", time: "10:30 - 11:30 AM", location: "Auditorium Complex", speaker: "Prof Nicu Sebe", variant: "plenary", link: "/" },
      { id: "b2", title: "Coffee Break", time: "11:30 AM - 12:00 PM", location: "Foyer", variant: "break", link: "/" },
      { id: "v1", title: "Vision India Session", time: "12:00 - 1:30 PM", location: "Auditorium Complex", description: "Showcasing research from Indian institutions", variant: "vision", link: "/vision-india" },
      { id: "l2", title: "Lunch", time: "1:30 - 2:30 PM", location: "Dining Hall", variant: "break", link: "/" },
      { id: "p2", title: "Plenary-2: Dr. Srinath Sridhar", time: "2:30 - 3:30 PM", location: "Auditorium Complex", speaker: "Dr. Srinath Sridhar", variant: "plenary", link: "/" },
      ...
      { id: "p3", title: "Plenary-3: Prof C V Jawahar", time: "5:30 - 6:30 PM", location: "Auditorium Complex", speaker: "Prof C V Jawahar", variant: "plenary", link: "/" },
      { id: "i1", title: "Industry Session-1", time: "6:30 - 7:30 PM", location: "Auditorium Complex", variant: "industry", link: "/industry-sessions" },
  ...
  "dec19": {
    ...
    sessions: [
      { id: "o2", title: "Oral Session-2", time: "9:00 - 10:30 AM", location: "Auditorium Complex", variant: "oral", link: "/oral-sessions" },
      { id: "p4", title: "Plenary-4: Prof. Paul Thompson", time: "10:30 - 11:30 AM", location: "Auditorium Complex", speaker: "Prof. Paul Thompson", variant: "plenary", link: "/" },
      { id: "b4", title: "Coffee Break", time: "11:30 AM - 12:00 PM", location: "Foyer", variant: "break", link: "/" },
      { id: "i2", title: "Industry Session-2", time: "12:00 - 1:30 PM", location: "Auditorium Complex", variant: "industry", link: "/industry-sessions" },
      { id: "l3", title: "Lunch", time: "1:30 - 2:30 PM", location: "Dining Hall", variant: "break", link: "/" },
      { id: "o3", title: "Oral Session-3", time: "2:30 - 3:30 PM", location: "Auditorium Complex", variant: "oral", link: "/oral-sessions" },
      { id: "ps2", title: "Poster Session-2", time: "3:30 - 5:30 PM", location: "Exhibition Hall", description: "Includes poster/oral papers, Tiny Papers Track posters + Coffee break", variant: "poster", link: "/poster-sessions" },
      { id: "p5", title: "Plenary-5: Dr P. Anandan", time: "5:30 - 6:30 PM", location: "Auditorium Complex", speaker: "Dr P. Anandan", variant: "plenary", link: "/" },
      { id: "gbm", title: "GBM / Student-Industry Interaction", time: "6:30 - 7:30 PM", location: "Multiple Rooms", description: "Parallel sessions", variant: "industry", link: "/" },
  ...
  "dec20": {
    ...
    sessions: [
      { id: "o4", title: "Oral Session-4", time: "9:00 - 10:30 AM", location: "Auditorium Complex", variant: "oral", link: "/oral-sessions" },
      { id: "i3", title: "Industry Session-3", time: "10:30 - 11:30 AM", location: "Auditorium Complex", variant: "industry", link: "/industry-sessions" },
      { id: "b6", title: "Coffee Break", time: "11:30 AM - 12:00 PM", location: "Foyer", variant: "break", link: "/" },
      { id: "i4", title: "Industry Session-4", time: "12:00 - 1:30 PM", location: "Auditorium Complex", variant: "industry", link: "/industry-sessions" },
      { id: "l4", title: "Lunch", time: "1:30 - 2:30 PM", location: "Dining Hall", variant: "break", link: "/" },
      { id: "o5", title: "Oral Session-5", time: "2:30 - 3:30 PM", location: "Auditorium Complex", variant: "oral", link: "/oral-sessions" },
      { id: "o6", title: "Oral Session-6", time: "3:30 - 4:30 PM", location: "Auditorium Complex", variant: "oral", link: "/oral-sessions" },
      { id: "val", title: "Valedictory Function", time: "4:30 - 5:30 PM", location: "Auditorium Complex", description: "Closing ceremony & awards", variant: "plenary", link: "/" },
      { id: "d3", title: "Dinner", time: "5:30 PM onwards", location: "Banquet Hall", variant: "break", link: "/" },
    ],
  },
};
